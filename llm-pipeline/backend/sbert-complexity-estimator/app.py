...
async def estimate_effort(req: EstimationRequest):
    ...
    with tempfile.TemporaryDirectory(dir="./temp") as temp_dir:
        ...
        try:
            ...
            similar_repos = get_top_k_similar_repos(req.description, 10)
            ...
            results = evaluate_multiple_repos(similar_repos, temp_dir)
            ...
            for repo in results:
                ...
                score = repo.get("similarity", 0.0)
                hours = repo.get("effort_hours", 0.0)
